...
import com.moh.hamadpulse.constants.DBContract;
import com.moh.hamadpulse.constants.DbHelper;
...
//       }
        ...
        searchicd10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                searchicd10.setIconified(false);
            }
        });
        searchicd10.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                ...
                if (s.length() >= 3) {
                    ...
                    String selection = DBContract.Icd.COLUMN_NAME_EN + " like '%" + s + "%'" + " or " + DBContract.Icd.COLUMN_CD + " like '" + s + "%'";
                    Log.e("selection", selection);
                    String[] selectionArgs = {"2"};
                    String orderby = DBContract.Icd.COLUMN_NAME_EN + " ASC";
                    final Cursor cursor = db.query(DBContract.Icd.TABLE_NAME, coulmns, selection, null, null, null, orderby);
                    SimpleCursorAdapter simpleCursorAdapter = new SimpleCursorAdapter(
                            icd10Activity.this,
                            R.layout.icd_list_row,
                            cursor,
                    ...
                    final Cursor cursor = db.query(DBContract.Icd.TABLE_NAME, coulmns, null, null, null, null, orderby);
                    SimpleCursorAdapter simpleCursorAdapter = new SimpleCursorAdapter(
                            icd10Activity.this,
                            R.layout.icd_list_row,
                            cursor,
