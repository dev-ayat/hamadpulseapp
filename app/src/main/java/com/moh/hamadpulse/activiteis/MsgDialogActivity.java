//package com.moh.pulsegh.activiteis;
//
...
//
//    public MsgDialogActivity(Activity actmsg) {
//
//        this.actmsg = actmsg;
//        cx = actmsg.getApplicationContext();
